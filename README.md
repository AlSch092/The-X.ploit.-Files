...
All findings were discovered by the repository owner/document author, alsch092 on GitHub, unless otherwise stated. In rare cases where a finding required the convergence or chaining of separate ideas, one additional contributor may be credited.  
